...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item menu-toggle__item--completed">
            ...
            <a href="<?= Url::to(['mylist/index', 'status' => Task::STATUS_DONE_TEXT]); ?>">
                Завершённые
            </a>
        </li>
        ...
        <li class="menu-toggle__item menu-toggle__item--active">
            ...
            <a href="<?= Url::to(['mylist/index', 'status' => Task::STATUS_ACTIVE_TEXT]); ?>">
                Активные
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--canceled">
            ...
            <a href="<?= Url::to(['mylist/index', 'status' => Task::STATUS_CANCEL_TEXT]); ?>">
                Отменённые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--hidden">
            ...
            <a href="<?= Url::to(['mylist/index', 'status' => Task::STATUS_FAIL_TEXT]); ?>">
                Просроченные
            </a>
        </li>
    </ul>
        ...
        <?php foreach($tasks as $task): ?>
            <div class="new-task__card">
                ...
                <div class="feedback-card__top ">
                    <a href="#"><img src="<?= Html::encode($task->performer->profiles->avatar) ?>" width="36" height="36"></a>
                    <div class="feedback-card__top--name my-list__bottom">
                        <p class="link-name"><a href="#" class="link-regular"><?= Html::encode($task->performer->name) ?></a></p>
                        <a href="#" class="my-list__bottom-chat  my-list__bottom-chat--new"><b><?= Html::encode(count($task->messages)) ?></b></a>
                        <span></span><span></span><span></span><span></span><span class="star-disabled"></span>
                        <b><?= Html::encode($task->performer->profiles->rating) ?></b>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
