                    ...
                    <h2>Последние задания на сайте</h2>
                        ...
                        <?php foreach($tasks as $task): ?>
                            <div class="landing-task">
                                <div class="landing-task-top task-<?= Html::encode($task->icon) ?>"></div>
                                <div class="landing-task-description">
                                    <h3><a href="#" class="link-regular"><?= Html::encode($task->title) ?></a></h3>
                                    <p><?= Html::encode(StringHelper::truncate($task->content,50,'...')) ?></p>
                                </div>
                                <div class="landing-task-info">
                                    <div class="task-info-left">
                                        <p><a href="#" class="link-regular"><?= Html::encode($task->category->category) ?></a></p>
                                        <p><?= Html::encode(Yii::$app->formatter->format(strtotime($task->date_published), 'relativeTime')) ?></p>
                                    </div>
                                    <span><?= Html::encode($task->cost) ?> <b>₽</b></span>
                                </div>
                            </div>
                        <?php endforeach; ?>
        ...
        <div class="main-container page-footer__container">
            <div class="page-footer__info">
                ...
                <p class="page-footer__info-use">
                    «<?= Html::encode(Yii::$app->name) ?>» — это сервис для поиска исполнителей на разовые задачи.
                    mail@taskforce.com
                </p>
            </div>
